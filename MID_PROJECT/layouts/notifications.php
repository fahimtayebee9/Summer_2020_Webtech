                ...
                <div class="col-12 rmv-pad scrollable-area">
                    <div class="content-area scrollbar title-header-main">
                        ...
                        <div class="row row-pad">
                            <div class="col-8">
                                <form action="../Php/filter_user_application.php" method="POST" class="filter-form">
                                    ...
                                    <div class="form-group">
                                        <input type="submit" value="Filter" name="filter" class="">
                                    </div>
                                </form>
                            </div>
                        </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Manager</td>
                                            <td>25000</td>
                                            <td><a href="approve_request.php" class="btn btn-info">View</a></td>
                                        </tr>
                                        <tr>
                                            <th scope="row">#JAPP-1221</th>
                                            <td>Ahmed Zubayer</td>
