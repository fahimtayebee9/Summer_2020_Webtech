...
<body>
    <section class="banner ">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto ul-align">
                        ...
                        <li class="nav-item">
                            <a class="nav-link hover-ani" href="layouts/packages.html">Packages</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link hover-ani" href="layouts/bookroom.html">Book Rooms</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class=" swiper-container wow fadeInLeftBig animation">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide ">
                        <div class="row w320 hg align-items-center ">
                            <div class="col-10 col-lg-8 col-md-8 col-sm-8 text-center m-auto">
                                <div class="banner-content">
                                    <h1>Hotel Management System</h1>
                                    <p>Become Premium customer by booking more than BDT.20000</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide ">
                        <div class="row w320 hg align-items-center ">
                            <div class="col-10 col-lg-8 col-md-8 col-sm-8 text-center m-auto">
                                <div class="banner-content header-animation">
                                    <h1>Hotel Management System</h1>
                                    <p>Book our rooms and feel the best services in town.</p>
                                </div>
                            </div>
                        </div>
                    </div>
