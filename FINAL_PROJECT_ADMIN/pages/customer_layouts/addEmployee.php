            ...
            <div class="row main">
                ...
                <div class="col-12 rmv-pad scrollable-area">
                    <div class="content-area scrollbar title-header-main">
                        ...
                        <div class="row row-pad justify-content-center align-items-center m-auto">
                            <div class="col-6">
                                <form action="../Php/add_emp_validation.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for="onepass">One Time Password</label>
                                        <input type="password" name="onePass" id="onepass" class="form-control">
                                    </div>
                                    <div class="form-group">
